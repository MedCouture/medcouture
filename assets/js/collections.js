...
$(document).ready(function () {
  ...
  var styles = [
    {
      ...
      collection: "peaches",
      description:
        'This sporty scrub top is so cool! It is loaded with personality with a "V" in front and the back. It also has geometric seam details that are genuinely original.',
      kind: "solids",
      features: [
        "Double v-neck",
    ...
    },
    {
      ...
      collection: "peaches",
      description:
        "You will love the fit of these flat front pants. They have a simple structure and are fun to wear. You will want to wear them every day!",
      kind: "bottoms",
      features: [
        "Straight leg ",
        "Two back pockets",
        ...
        "Outer waist ties",
        "R: XS-3X (30”) P XS-2X (28”) T: XS-XL (32 1/2”)"
      ],
      swatches: ["ROYL", "PWTR", "PKPH", "NAVY", "GELO", "CLOD", "BLAC"],
      isActive: true,
      appendSwatches: function appendSwatches() {
    ...
    },
    {
      ...
      description:
        "This classic scrub top is the perfect blend of classic style and comfort. This poly blend fabric is easy care and feels like cotton! ",
      kind: "solids",
      features: [
        "Classic silhouette",
        "Two angled welt pockets",
    ...
    },
    {
      ...
      collection: "touchclassic",
      description:
        "These scrub pants are the perfect blend of classic style and comfort. You'll love the waistband. Outer waist ties ensure a perfect fit! ",
      kind: "bottoms",
      features: [
        "Straight leg",
    ...
    },
    {
      ...
      collection: "layers",
      description:
        "This warm up jacket covers all your bases. You’ll be warm and cozy on cold work days and it’s sport zipper ensures easy off and on. ",
      kind: "layering",
      features: [
        "95% polyester, 5% spandex",
    ...
    },
    {
      ...
      collection: "layers",
      description:
        "This cozy over scrub jacket is designed to keep you warm on those cold office days. It features hidden inside pockets and a sport-inspired colar.",
      kind: "outerwear",
      features: [
        "100% polyester",
    ...
    },
    {
      ...
      collection: "layers",
      description:
        "Our sporty zip front warm-up jacket is warm and comfortable. With large curved pockets and soft knit cuffs, this jacket transforms from office wear to activewear!",
      kind: "layering",
      features: [
    ...
    },
    {
      ...
      collection: "layers",
      description:
        "Resist the cold in this warm-up jacket. Designed with function in mind, it has four pockets and a smooth zipper. You’ll stay seriously warm in comfort.",
      kind: "layering",
      features: [
    ...
    },
    {
      ...
      collection: "layers",
      description:
        "Perfect for fluctuating temperature, this vest flaunts the warmth of bonded fleece yet provides the freedom to move.",
      kind: "layering",
      features: [
        "100% polyester",
        "Zipper pull functions as hair tie",
  ...
  var filterStyle = function filterStyle(e) {
    e.preventDefault();
    console.log("i am clicked"); //on click the user will see the results
  ...
  var disableOverlay = function disableOverlay() {
    var $searchResults = $(".search-results");
    $searchResults.css({
      display: "none",
      color: "#fff",
