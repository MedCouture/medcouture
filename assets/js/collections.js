...
$(document).ready(function () {
  ...
  var styles = [{
    ...
    appendSwatches: function appendSwatches() {
      for (var i = 0; i < this.swatches.length; i++) {
        ...
        $('#swatches').append("\n                        <button class='".concat(swatches, " ml-2 swatches' data-color='").concat(swatches, "'></button>\n                    "));
      }
    },
    ...
    appendSwatches: function appendSwatches() {
      for (var i = 0; i < this.swatches.length; i++) {
        var swatches = this.swatches[i];
        $('#swatches').append("\n\n                        <button class='".concat(swatches, " ml-2' data-color='").concat(swatches, "'></button>\n\n                    "));
      }
    }
  }, {
    style: '8564piwh',
  ...
  var generateItemsHtml = function generateItemsHtml() {
    for (var i = 0; i < styles.length; i++) {
      if (style == styles[i].style) {
        $('#view').html("\n                    <div class=\"container p-md-5 mb-5 text-sofia\">\n                        <div class=\"row\">\n                            <div class=\"col-sm-12\">\n                                <div>\n                                    <h1 class='hidden-lg text-uppercase'>".concat(styles[i].style, "<br><small class='text-uppercase'>").concat(styles[i].name, "</small></h1>\n                                </div>\n                            </div>\n                            <div class=\"col-sm-6\">\n                                <div id=\"style-showcase\">\n                                    <img src=\"../../assets/images/products/products/").concat(styles[i].style, ".jpg\" alt=\"").concat(styles[i].style, "\" class=\"img-fluid mb-2\" onError=this.src=\"../../assets/images/products/products/blank.jpg\">\n                                    <div class=\"container-fluid hidden-sm\">\n                                        <div class=\"row\">\n                                            <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(styles[i].style, ".jpg\"\n                                                alt=\"").concat(styles[i].style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"front\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                                            <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(styles[i].style, "_back.jpg\"\n                                            alt=\"").concat(styles[i].style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"back\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                                            <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_sketch.jpg\"\n                                            alt=\"").concat(style, "_sketch\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"sketch\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"col-sm-6\">\n                                <div class=\"container\">\n                                    <div class=\"row\">\n                                        <div class=\"col-sm-12\">\n                                            <div>\n                                                <h1 class='hidden-sm text-uppercase'>").concat(styles[i].style, "<br><small class='text-uppercase'>").concat(styles[i].name, "</small></h1>\n                                            </div>\n                                            <br>\n                                            <br>\n                                            ").concat(styles[i].description, "<br><br>\n                                            <ul id=\"features\">\n                                            </ul>\n                                        </div>\n                                        <div id=\"swatches\" class=\"col-sm-12\">\n                                        <br>\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                "));
  ...
  var generateCollectionsHtml = function generateCollectionsHtml() {
    for (var i = 0; i < styles.length; i++) {
      if (style === styles[i].collection && styles[i].isActive) {
        $('#collections-view').append("   <div class=\"col-md-3 col-sm-6 p-3 text-sofia text-blue text-uppercase\">\n                            <a href=\"../collections/items/".concat(styles[i].style, ".html\"><img src=\"../assets/images/products/products/").concat(styles[i].style, ".jpg\" \n                            alt=\"").concat(styles[i].name, "\" class=\"img-fluid\"></a>\n                            ").concat(styles[i].style, " <br> ").concat(styles[i].name, "\n                        </div>\n                    "));
      }
    }
  };
  ...
  var generateProductsHtml = function generateProductsHtml() {
    for (var i = 0; i < styles.length; i++) {
      if (style === styles[i].kind && styles[i].isActive) {
        $('#products-view').append("   <div class=\"col-md-3 col-sm-6 p-3 text-sofia text-blue text-uppercase\">\n                            <a href=\"../collections/items/".concat(styles[i].style, ".html\"><img src=\"../assets/images/products/products/").concat(styles[i].style, ".jpg\" \n                            alt=\"").concat(styles[i].name, "\" class=\"img-fluid\"></a>\n                            ").concat(styles[i].style, " <br> ").concat(styles[i].name, "\n                        </div>\n                    "));
      }
    }
  };
  ...
  var imageStyleColorChange = function imageStyleColorChange() {
    $('.swatches').on('click', function () {
      ...
      console.log(color);
      $('#style-showcase').html("\n            <img src=\"../../assets/images/products/products/".concat(style, "_").concat(color, ".jpg\" alt=\"").concat(style, "_").concat(color, "\" class=\"img-fluid showcased-style mb-2\" data-style=\"").concat(style, "_").concat(color, "\" onError=this.src=\"../../assets/images/products/products/blank.jpg\">\n            <div class=\"container-fluid hidden-sm\">\n            <div class=\"row\">\n                <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, ".jpg\"\n                    alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"front\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_back.jpg\"\n                alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"back\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_sketch.jpg\"\n                alt=\"").concat(style, "_sketch\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"sketch\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n            </div>\n            "));
    });
  };
  ...
  var thumbnailImageChange = function thumbnailImageChange() {
    $('body').on('click', '.thumbnails', function () {
      ...
      if (orientation === "front") {
        $('#style-showcase').html("\n                <img src=\"../../assets/images/products/products/".concat(style, ".jpg\" alt=\"").concat(style, "\" class=\"img-fluid mb-2\" onError=this.src=\"../../assets/images/products/products/blank.jpg\">\n                <div class=\"container-fluid hidden-sm\">\n                <div class=\"row\">\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, ".jpg\"\n                        alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"front\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_back.jpg\"\n                    alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"back\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_sketch.jpg\"\n                    alt=\"").concat(style, "_sketch\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"sketch\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                </div>\n            "));
      } else if (orientation === "back") {
        $('#style-showcase').html("\n                <img src=\"../../assets/images/products/products/".concat(style, "_back.jpg\" alt=\"").concat(style, "_back\" class=\"img-fluid mb-2\" onError=this.src=\"../../assets/images/products/products/blank.jpg\">\n                <div class=\"container-fluid hidden-sm\">\n                <div class=\"row\">\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, ".jpg\"\n                        alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"front\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_back.jpg\"\n                    alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"back\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_sketch.jpg\"\n                    alt=\"").concat(style, "_sketch\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"sketch\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                </div>\n            "));
      } else if (orientation === "sketch") {
        $('#style-showcase').html("\n                <img src=\"../../assets/images/products/products/".concat(style, "_sketch.jpg\" alt=\"").concat(style, "_sketch\" class=\"img-fluid mb-2\" onError=this.src=\"../../assets/images/products/products/blank.jpg\">\n                <div class=\"container-fluid hidden-sm\">\n                <div class=\"row\">\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, ".jpg\"\n                        alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"front\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_back.jpg\"\n                    alt=\"").concat(style, "\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"back\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                    <div class=\"col-sm-4\"><img src=\"../../assets/images/products/products/").concat(style, "_sketch.jpg\"\n                    alt=\"").concat(style, "_sketch\" class=\"img-fluid img-thumbnail thumbnails\" data-orientation=\"sketch\" onError=this.src=\"../../assets/images/products/products/blank.jpg\"></div>\n                </div>\n            "));
      }
    });
  };
